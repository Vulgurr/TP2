...
public class GestorVecinos {
	Vecino lider1;
	Vecino lider2;
	Set<Integer> totalVecinosAConsiderar;
	...
	public void agregarAmistades(int numero1, int numero2, int valor)
	{
		...
		if(numero1 != idLider1 && numero2 != idLider1 
			&& numero1 != idLider2 && numero2 != idLider2)
		{//No me interesa una amistad si no es entre los dos vecinos
			return;
		}
		if(numero1 == idLider2)
